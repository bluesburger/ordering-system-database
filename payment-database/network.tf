...
resource "aws_subnet" "subnet1" {
  ...
  tags = {
    Name = "subnet-terraform-payment-public-1"
  }
}
...
resource "aws_subnet" "subnet2" {
  ...
  tags = {
    Name = "subnet-terraform-payment-public-2"
  }
}
...
resource "aws_subnet" "subnet3" {
  ...
  tags = {
    Name = "subnet-terraform-payment-public-3"
  }
}
...
resource "aws_internet_gateway" "internet_gateway" {
  ...
  tags = {
    Name = "internet-gateway-payment-terraform"
  }
}
...
resource "aws_route_table" "route_table" {
  ...
  tags = {
    Name = "route-table-payment-terraform"
  }
}
...
resource "aws_security_group" "security_group" {
  ...
  tags = {
    Name = "security_group-payment-terraform"
  }
}
